...
```bash
owf gen "एक code review process बनाओ" -o review.js   # एक वाक्य से workflow script generate करें
owf gen review.js "इसमें एक security review node और जोड़ो"  # एक वाक्य से मौजूदा script modify करें
owf run review.js                          # script को run करें
```

बस यही तीन उपयोग हैं (असल में commands दो ही हैं — `gen` और `run`)।

**`owf gen`** natural language से workflow generate या modify करता है। यह interface के नीचे वाले AI input box जैसी ही capability है: आप requirement बताते हैं, यह script generate करता है; आप किसी मौजूदा script की तरफ इशारा करके बताते हैं कि क्या बदलना है, और यह बदल देता है।

यहां एक अहम बात है: **यह zero-config है, आपको कोई API Key नहीं भरना पड़ता**। क्योंकि यह आपके local machine पर पहले से login किए हुए `claude` CLI को ही reuse करता है (और runtime में भी यही path उपयोग होता है), तो जब तक आपके पास claude installed है और आप login हैं, `owf gen` सीधे काम करता है। अगर installed नहीं है तो यह आपको पहले `claude login` करने की याद दिलाता है।

**`owf run`** script को run करता है, node-by-node execute करता है, और terminal में real-time progress print करता है:
